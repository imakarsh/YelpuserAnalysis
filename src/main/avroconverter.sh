...
java -jar avro-tools-1.7.7.jar fromjson --codec snappy --schema-file resources\yelp_user.avsc resources\yelp_academic_dataset_user.json > resources\yelp_user.avro
